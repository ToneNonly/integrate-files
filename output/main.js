...
let CYCLE_OPTIONS = [{target: "#searchipt", move: "input", time: 0}, {target: ".searchlogo", move: "click", time: 0}, {target: ".serp-list .poibox", move: "click", beforeMove: function beforeMove(target) {
                        if (!target || target.className.indexOf('poibox-empty') > -1) return false
                        return true
                    }, time: 3000}, {target: ".collect", move: "click", beforeMove: function beforeMove(target) {
